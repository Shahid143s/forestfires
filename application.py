...
Ws = st.number_input('Wind Speed', min_value=0.0, max_value=100.0, step=0.1)
Rain = st.number_input('Rain', min_value=0.0, max_value=100.0, step=0.1)
FFMC = st.number_input('Fine Fuel Moisture Code', min_value=0.0, max_value=100.0, step=0.1)
DMC = st.number_input('Duff Moisture Code', min_value=0.0, max_value=1000.0, step=0.1)
ISI = st.number_input('Drought Code', min_value=0.0, max_value=100.0, step=0.1)
